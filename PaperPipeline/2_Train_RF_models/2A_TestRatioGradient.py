...
Study_Title = 'RSCU_TestRatioGradient'

CPU_USED = os.cpu_count() - 3
#CPU_USED = int(os.cpu_count() / 2) - 3
#CPU_USED     = 5
...
FINAL_RESULT = {}
Run_List = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
for Index, TEST_SIZE in enumerate(Run_List):
    ...
    ss.database_save(study, f"{FILENAME_OUTPUT}//study_{TEST_SIZE}", 'Output')
